...
export const metadata: Metadata = {
  ...
  description: "Control Your AI Coding Agent From Anywhere - Learn how to improve your development workflow with Termote's browser-based terminal.",
      ...
      <main className="pt-16 pb-20">
        <article className="mx-auto max-w-3xl px-4">
          <header className="py-12 text-center">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-6">Control Your AI Coding Agent From Anywhere</h1>
          </header>

          <div className="prose prose-invert max-w-none">
            <div className="text-zinc-300 leading-relaxed space-y-6">
              <p className="text-lg text-zinc-400">
                This guide covers control your ai coding agent from anywhere and how Termote can help improve your workflow.
              </p>
